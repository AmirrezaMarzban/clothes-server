module.exports._sr = {
  fa: {
    required: {
      gymId: 'شناسه باشگاه را ارسال کنید',
      tutorialId: 'شناسه آموزش را ارسال کنید',
      ...
      brands: 'برند مورد نظر را وارد کنید',
      ...
      rate: 'لطفا امتیاز بدهید',
      plan: 'لطفا یک پلن انتخاب کنید',
      color: 'لطفا یک رنگ انتخاب کنید',
      merchantId: 'لطفا توکن درگاه زرین پال خود را وارد کنید',
      location: 'لوکیشن خود را وارد کنید',
      itemId: 'شناسه آیتم را ارسال کنید',
    },
    format: {
      all: 'فرمت صحیح نیست',
      ...
      png: 'فرمت عکس png باید باشد',
      file: 'فرمت فایل قابل قبول نیست',
    ...
    not_found: {
      gymId: 'باشگاهی با این شناسه وجود ندارد',
      ...
      store: 'فروشگاه مورد نظر پیدا نشد',
      category: 'دسته بندی مورد نظر وجود ندارد',
      tutorial: 'آموزش مورد نظر پیدا نشد',
      product: 'محصول مورد نظر پیدا نشد',
      brands: 'برند مورد نظر پیدا نشد',
      news: 'خبر مورد نظر پیدا نشد',
      comment: 'نظر مورد نظر پیدا نشد',
      articles: 'مقاله مورد نظر پیدا نشد',
      tickets: 'تیکت مورد نظر پیدا نشد',
      media: 'رسانه مورد نظر پیدا نشد',
    },
    duplicated: {
      ...
      national_code: 'این کد ملی از قبل وجود دارد',
      uniqueId: 'این شناسه قبلا توسط یک باشگاه دیگر استفاده شده است'
    },
    response: {
      logged_in: 'شما وارد سیستم شدید',
      registered: 'شما با موفقیت ثبت نام شدید',
      registered_owner: 'شما با موفقیت ثبت نام شدید پس از تایید شدن اطلاعات حسابتان میتوانید محصول و فروشگاه خود را ثبت کنید',
      not_logged_in: 'شما وارد سیستم نشدید',
      id_error_upload: 'تصویر پشت و روی کارت ملی را آپلود کنید',
      ...
      delete_request: 'درخواست حذف محصول ارسال شد پس از تایید محصول حذف خواهد شد',
      already_has_address: 'آدرس قبلا اضافه شده',
      activation_code: 'کد فعالسازی برای شما ارسال شد',
      has_sent_activation_code: 'کد فعالسازی برای شما ارسال شده است بعد از ۱۲۰ ثانیه دوباره تلاش کنید',
      wrong_activation_code: 'کد فعالسازی اشتباه است',
      activation_email: 'کد فعالسازی برای ایمیل شما ارسال شد',
      ...
      verify_account: 'ابتدا شماره خود را تایید کنید',
      ...
      nestedError: 'این دسته بندی شامل زیر مجموعه است. ابتدا آن ها را از زیر مجموعه هایشان خارج کنید',
      repetitiveParentCategory: 'دسته بندی نمیتواند زیر مجموعه خودش باشد',
      persianChar: 'لطفا با حروف فارسی بنویسید',
      wrong_mode: 'حالت درست را انتخاب کنید',
      whiteSpace: 'بین حروف و کلمات نباید فاصله باشد',
      unknownError: 'مشکلی در اجرای درخواست شما بوجود آمده است',
      exist_tutorials: 'این دسته بندی دارای آموزش می باشد ابتدا آموزش ها را حذف کنید',
      exist_items: 'این دسته بندی دارای آیتم می باشد ابتدا آیتم ها را حذف کنید',
      forbidden: 'دسترسی غیر جاز'
    },
    file_types: {
  ...
  en: {
    required: {
      ...
      registered_owner: 'You have been successfully registered after that verification you can submit your shops and products',
    ...
    format: {
      ...
      file: 'File format is not acceptable',
    ...
    not_found: {
      ...
      category: 'There is no category with this Id',
      news: 'The news is not found',
      articles: 'The article is not found',
      store: 'The store is not found',
      brands: 'The brand is not found',
      comment: 'The comment is not found',
      product: 'The product is not found',
      tickets: 'The ticket is not found',
      media: 'The media is not found',
    },
    duplicated: {
      ...
      national_code: 'National code already exists'
    },
    response: {
      logged_in: 'You are logged in',
      not_logged_in: 'You are not logged in',
      id_error_upload: 'upload the back and forth of id',
      ...
      delete_request: 'The remove request has been sent, After the verification the product will be remove from your store',
      ...
      verify_account: 'You need to verify your mobile first.',
      nestedError: 'This category contains another categories, At first delete dependent categories.',
      repetitiveParentCategory: 'the category cannot contain itself',
      ...
      wrong_mode: 'Please enter the right mode',
